          ...
          <div className="col-md-12">
            <div className="footer__main">
              ...
              <form action="#" className="form">
                ...
                <button className="action-btn"  style={{marginBottom: "20px"}}>
                  <span>Subscribe</span>
                </button>
              </form>
            </div>
            <div className="footer__bottom" style={{ background: 'linear-gradient(to bottom, #4FC3F7, #1565C0)' }}>
              ...
              <div className="center mb--30">
                ...
                <p style={{color: "white"}}>Copyright © 2022, Web5 Solution</p>
              </div>
